...
@section('content')
  <div class="container-fluid px-6 py-8">
    ...
    <div class="flex items-center mb-6">
      ...
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Create New Bill</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Add a new bill for a resident</p>
      </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select name="bill_type" required
              ...
              <option value="common_area" {{ old('bill_type') == 'common_area' ? 'selected' : '' }}>Common Area Fee</option>
              ...
              <option value="insurance" {{ old('bill_type') == 'insurance' ? 'selected' : '' }}>Insurance</option>
              <option value="parking" {{ old('bill_type') == 'parking' ? 'selected' : '' }}>Parking Fee</option>
          ...
          <div>
            ...
            <input type="number" name="amount" step="0.01" min="0" value="{{ old('amount') }}" required placeholder="0.00"
