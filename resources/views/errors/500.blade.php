          ...
          <div class="w-full px-5">
            <div class="scroll-revealed mx-auto max-w-[780px] text-center">
              ...
              <p class="mx-auto mb-9 max-w-[600px] text-base text-primary-color sm:text-lg sm:leading-normal">
                Sorry, something went wrong. We're working on it!<br>If you have any questions, please <a href=""
                  class="text-white underline hover:text-white" onclick="alert('Admin has been informed')">contact
                  our admin</a>
              </p>
