<x-guest-layout>
    ...
    <div class="text-center mb-6">
        ...
        <p class="text-sm text-body-light-11 dark:text-body-dark-11">
            You're using a default password. Please set a new secure password to continue
        </p>
    </div>

    <!-- Password Change Form -->
    <form method="POST" action="{{ route('password.update.force') }}" class="space-y-3.5">
        @csrf
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-xs font-medium text-body-light-12 dark:text-body-dark-12 mb-1.5">
                Confirm Password
            </label>
