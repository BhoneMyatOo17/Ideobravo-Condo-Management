...
@section('page-title', 'Add Condominium')
...
@section('content')
  <div class="max-w-4xl mx-auto">
    ...
    <!-- Page Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Condominium</h1>
      <p class="text-gray-500 dark:text-gray-400 mt-1">Register a new condominium property in the system</p>
    </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div class="sm:col-span-2">
              ...
              <input type="text" name="name" id="name" value="{{ old('name') }}" required
                placeholder="e.g., Ideo Q Sukhumvit 36"
            ...
            <div class="sm:col-span-2">
              ...
              <textarea name="address" id="address" rows="2" required placeholder="Full address of the condominium"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="juristic@example.com"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
            </div>
            ...
            <div>
              ...
              <input type="text" name="line_id" id="line_id" value="{{ old('line_id') }}" placeholder="@condolineid"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
            </div>
          </div>
        </div>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input type="number" name="total_floors" id="total_floors" value="{{ old('total_floors') }}" min="1"
                placeholder="e.g., 35"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
            </div>
            ...
            <div>
              ...
              <input type="number" name="total_units" id="total_units" value="{{ old('total_units') }}" min="1"
                placeholder="e.g., 500"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
            </div>
            ...
            <div>
              ...
              <input type="number" name="built_year" id="built_year" value="{{ old('built_year') }}" min="1900"
                max="{{ date('Y') + 5 }}" placeholder="e.g., 2020"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
            </div>
          </div>
        </div>
